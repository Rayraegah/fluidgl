...
function startGUI() {
    ...
    gui.add(config, 'VELOCITY_DISSIPATION', 0.9, 1.0).name(
        'velocity diffusion'
    );
    gui.add(config, 'PRESSURE_DISSIPATION', 0.0, 1.0).name(
        'pressure diffusion'
    );
...
let ditheringTexture = createTextureAsync('./texture/LDR_RGB1_0.png');
